...
using TicketApp.Services.Implementation;
...
namespace TicketApp.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDefaultIdentity<TicketAppApplicationUser>(options => options.SignIn.RequireConfirmedAccount = true)
...
.AddEntityFrameworkStores<ApplicationDbContext>();
            ...
            services.AddScoped<IUserClaimsPrincipalFactory<TicketAppApplicationUser>, UserClaimsPrincipalFactory<TicketAppApplicationUser, IdentityRole>>();
