...
namespace TicketApp.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly SignInManager<TicketAppApplicationUser> signInManager;
        public AccountController(UserManager<TicketAppApplicationUser> userManager, SignInManager<TicketAppApplicationUser> signInManager)
        {
